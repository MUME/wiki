...
[Look](./Look.md) - This is used to look at people, objects,
exits, creatures, or rooms. It will provide a description on what is
being looked at if one is available.

[Examine](./Examine.md) - This command can be used to look at an
...
[Inventory](./Inventory.md)(abbreviated IN) - shows a list of the
items which you are not wearing or holding in your hands, but which you
are carrying with you.

[Wield](./Wield.md) - picks up a weapon in your hand so that it
can be used. Example: 'wield longsword'

[Wear](./Wear.md) - puts on an article of clothing or armor. 'wear
...
[Sing](./Sing.md), [Tell](./Tell.md) - These are commands
...
people you might want to. [Narrate](./Narrate.md) and
[Sing](./Sing.md) are global channels, which means anyone who
wants to can hear them anywhere. [Say](./Say.md) is for people in
the same room as you. [Tell](./Tell.md) is used to talk to one
particular person no matter where they are. Read [FAQ5](./FAQ5.md)
...
[Rest](./Rest.md), [Sleep](./Sleep.md) - These allow you to
...
[FAQ3](./FAQ3.md) on how to fill cups, and [FAQ4](./FAQ4.md)
on how to hunt for food.

[Time](./Time.md) - This command gives the present time to the
...
[Info](./Info.md) - This command gives you information on your
...
[Score](./Score.md) - This gives information on your current hits,
...
[Practice](./Practice.md) - This command shows what skills or
...
'[Practice](./Practice.md)' shows what is available to be learned,
and how hard it will be to learn it. Check the guild boards
([FAQ5](./FAQ5.md)), libraries and other sources of information to
decide what to practice.

[Consider](./Consider.md) - You use this to consider if it would
...
[Change Wimpy](./Wimpy.md) &lt;NUMBER&gt; - This command allows you to
...
[Flee](./Flee.md) - A very useful command when things are not
