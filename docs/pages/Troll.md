---
title: Troll
description: 'Trolls have the greatest physical might. These huge figures may be'
tags:
  - Playable races
---
...
[bare-handed](./Unarmed.md) fighters. They have extremely low
...
- They suffer [tremendous damage under sunlight](./Sundeath.md).
- A Troll will see all non-Trolls except [Black
  Númenóreans](./Black_Númenórean.md) in the room by their race
  name (\*an Elf\*, -Snarf the Orc- etc). The same applies for
  non-Trolls seeing Trolls. The one exception to this rule is that a
  Troll grouped by a [Black Númenórean](./Black_Númenórean.md)
...
More elaborate [troll guide](./Troll_guide.md). <!--@include: ../includes/ClassRace.md-->
