...
### [Aldereon](./Aldereon.md) the Wise

This old and wise Elf lives east of the [Grey
Havens](./Grey_Havens.md). He has quite a wide correspondence
...
This [Dwarf](./Dwarf.md) is located on the upper level of the
...
- Location: Upper level of the [Blue
  Mountains](./Blue_Mountains.md) dwarven city.
...
A delivery from the north to [Bree](./Bree.md) seems to have gone
...
- Reward: [Whetstone](./Whetstone.md), 2 gold, and 2000 exp.
...
In the forest of Lothlórien the Galadhrim hold many arts unknown to Men,
...
the shade of [Fangorn](./Fangorn.md), where strangers are seldom
...
- Quest: The [ancient weaver](./Ancient_weaver.md) will mention
  ...
  ropes](./Sturdy_rope.md) can be found in the supply cabinet in
...
The [crippled ranger](./Tower_Hills_Ranger_Guild.md) in [Black
Hill](./Black_Hill.md) needs someone to retrieve items that
villagers have lost.
...
- Quest: Agree when he the hunter asks you to kill some rats in a nearby
  ...
  Hill](./Black_Hill.md) village, past the [ranger's
...
of the Enemy. One of these Dúnedain lore masters is believed to live
