---
title: Shout
description: 'The shout command can be used to give a message to everyone in the'
tags:
  - Help files
  - Commands
---
...
[Narrate](./Narrate.md) command which can be turned off by those
