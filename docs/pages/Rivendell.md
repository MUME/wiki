---
title: Rivendell
description: 'The Last Homely House of Elrond is located in'
tags:
  - Cities
---
...
- [Rivendell Cleric Guild](./Rivendell_Cleric_Guild.md)
- [Rivendell Mage Guild](./Rivendell_Mage_Guild.md) /
  [Erestor](./Erestor.md)
- [Rivendell Ranger Guild](./Rivendell_Ranger_Guild.md)
- [Rivendell Scout Guild](./Rivendell_Scout_Guild.md)
- [Rivendell Warrior Guild](./Rivendell_Warrior_Guild.md)
