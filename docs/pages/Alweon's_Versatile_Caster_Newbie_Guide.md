...
description: 'Can''t decide between playing a Mage or Cleric? This guide shows you how'
---
...
guide](./Staff,_Gem_and_Focus_guide.md) for more details. To make
...
- Check the [General guide with rare useful
  information](./General_guide_with_rare_useful_information.md)
