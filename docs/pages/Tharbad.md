---
title: Tharbad
description: 'The once lawful city of Tharbad has long since been abandoned to'
tags:
  - Cities
---
The once lawful city of **Tharbad** has long since been abandoned to
civilised use. Lying far south from [Bree](./Bree.md), along the
...
- [Tharbad Cleric Guild](./Tharbad_Cleric_Guild.md)
- [Tharbad Mage Guild](./Tharbad_Mage_Guild.md)
- [Tharbad Thieves' Guild](./Tharbad_Thieves'_Guild.md)
- [Rooftop Thieves' Guild](./Rooftop_Thieves'_Guild.md)
- [Sewers Thieves' Guild](./Sewers_Thieves'_Guild.md)
