---
title: Butcher
description: 'Travelling in the wilderness can sometimes result in the poor explorer'
tags:
  - Help files
  - Commands
---
...
should be able to give you some [food](./Food.md), hides or
whatever, type "butcher [corpse](./Corpse.md)", and you will soon
find out if you were able to produce anything useful.

To easier pick the right corpse, you can also "butcher pig-corpse" or
similar.

Of course, you need to [wield](./Wield.md) some kind of tool to be
