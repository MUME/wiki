---
title: Bree
description: 'In the small area of Bree-Land there are four villages; Archet, Staddle,'
tags:
  - Cities
---
...
World, over the [Misty Mountains](./Misty_Mountains.md). From
there in the year 1601 ([Third Age](./Third_Age.md)), the Shire
was colonised.

Nowadays, there is little communication between Bree and the
[Shire](./Shire.md), the Hobbits of both finding the others
strange and foreign.

As well as standing upon the [Great Old Road](./Old_East_Road.md),
...
Bree-Landers renamed it the [Greenway](./Greenway.md).
...
- [Bree Scout Guild](./Bree_Scout_Guild.md)
- [Bree Ranger Guild](./Bree_Ranger_Guild.md)
- [Bree Warrior Guild](./Bree_Warrior_Guild.md)
- [Druid](./Druid.md) (near Bree)
