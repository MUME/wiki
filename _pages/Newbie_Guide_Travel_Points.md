...
<nowiki>gLevel 1 1 exp, 0 tp Level 2 1,000 exp, 100 tp Level 3 3,000
exp, 300 tp Level 4 7,000 exp, 600 tp Level 5 14,500 exp, 1,000 tp
...
<nowiki>gYou have scored 21,552,689 experience points and you have
144,252 travel points.
...
You can also look at map global travel to see the entire game map for
this information.
...
They are also required for leveling up, much like experience points. You
...
travel points. For example the Old East Road between Bree and Shire.
Very often travelled by many players, almost never a travel point is
there.

To gain more travel points, you want to try and visit rooms and areas of
the game that are not visited very often.
...
and the room has not had time to accumulate more of them yet.

This may or may NOT be how it works, but you can use this as a guide to
understanding travel points. Lets say a room has 100 travel points in
it, and someone enters that room. Those travel points are then
redistributed around the rest of the rooms in the game. If a room hits
100 travel points, it stops accumulating any new travel points, and they
instead go to other rooms that have not been visited very much or very
recently.

## **TPs and Grouping**

If you are in a group, you share the travel points in a room, but it's
not evenly shared. The leader of the group, entering the room first,
gains a small bonus, while the rest of the members of the group gain
about 20% less travel points from that room.
...
are mixing all styles together, you should stay current on your amount
of tps needed.

### Quests

Quests do not just reward you with coins, gear, or xp. A few quests in
the game grant TPs as a reward, the first time you do the quest.

### Discovering Secret Doors

Every time you discover a secret door, you gain 9 TPs. There are
different ways to discover them. If someone else has left the door open,
and you walk into the room and see it, that counts as a discovery. If
you attempt to open the door, but you cannot because it is locked, does
damage, or is too heavy, that also counts as a discovery.
...
Check out the map travelled command to see where you have and have not
been.

Some skills, such as **Ride**, **Wilderness**, **Endurance**, and
**Breath of Briskness** can help with travelling.
...
Mounts, a saddle, and a ranks in the ride skill. If you are riding alot
or long distances, you should have ride over 75%. Many players have it
over 90%.

The mounts that are good for this are mountain mules or dales ponies for
shorter races. Trained horses, war horses, Rohirrim horses for taller
races.

Players of the Rohirrim subrace gain a bonus to riding and dealing with
mounts.

A light pair of boots, that helps out movement. Examples are:

black padded boots (the lightest), smooth black boots (also a sheath),
and fine soft leather boots

If you are exploring in areas with alot of snow, snowshoes might be a
good idea. Like in parts of the Misty Mountains.

Rope can be handy exploring in a group, fine elven rope from a quest in
Lorien is the best. This can help players with less climb skill still
get around.

Canoes, rafts, boats, can all help you explore surface water rooms. A
few rooms in the game have rapids, and boats can't go down them. Also
boats are CRAZY HEAVY and can run you out of moves pretty quickly.

Several items you can wear on your back help with movement regen:

Woollen traveller's cloak helps with move regen a little bit
...
All troll characters require much less tps to level up then any other
races in the game.

Fallohide hobbits gain travel points more efficiently then other races,
and help can help others in their groups gain travel points as well.
They ignore the small penalty to TPs being shared in a group.

## **Storyteller and TPs**

If you gain ALOT of travel points, you might end up on the traveller's
list. Just visit the storyteller in Bree and 'ask storyteller travel'

It's similiar to the war lord list, but for players that have traveled
alot of the map, and while doing so, gained alot of travel points.