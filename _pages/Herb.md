...
Many different **herbs** can be found in [MUME](MUME "wikilink"), and a
great many of them are used in various [herblores](herblore "wikilink").

Some of these can be crushed, for instance:

"a woody stemmed plant", when held and crushed, will become "some narrow
leaves"

When making a herblore, it is important to see the difference between
the crushed and the original plant.

As usual plants/bushes/shrubs doesn't have keywords, but
leaves/flowers/petals have it. To crush plant/flower/etc type "remove
<weapon>", "hold <plant>" and "crush <plant>".
...
` Description (inv): slender-stemmed plant, with a brown head`
` Location:     UNKNOWN`

## Buttercups

` Description:  Yellow flowers, with grey-green foliage, grow in clusters here`
` Location:     Harlond area; Eregion; Dunland`
...
` Location:  Loads on `[`Dunlending`](Dunlending "wikilink")` children south of Dunland tower`

## Elanor

` Description:  Delicate golden blooms adorn the ground like a cascade of stars`
` Location:     Lothlorien`

## Ferns

` Description:  A cluster of dark green, feathery fronds flourishes in the shade`
...
` Description (inv): some sticky gooseberry preserve`
` Location:     inside farm south of the Forlond`

## Grapes

` Description:  Some plump of juicy grapes are growing here`
...
` Description:  A beautiful, ivory coloured rose with a tint of crimson is blossoming here`
` Location:     UNKNOWN`

## Mint

` Description:  A clean fragrance drifts up from a thick clump of leaves`
` Location:     RTT by Morthan; Tbad area; Eregion`

## Niphredil

` Description:  Several blooms of snow-white and palest green cover the ground`
` Location:     Lothlorien`

## Orchid

` Description:  An orchid of light violet petals blossoms nearby`
` Location:     Lothlorien`
...
` Description:  Some delicious wild strawberries grow on the ground`
` Location:     BM area; some e of Moria; Dunland`

## Thistles

` Description:  Prickly, white-stemmed plants, with blue flower heads grow in abundance`
` Location:     Harlond zone; Eregion; Dunland; Lothlorien`

## White rose

` Description:  A detached white rose is lying here`
